        ...
        <li className="catalog__item">
            ...
            <div className="catalog__item-text">
                ...
                <p className="catalog__item-price item_price">
                    {product.price}
                    <span className="catalog-item-currency">руб.</span></p>
            </div>
            <div className="catalog__item-btns-size">
                <button className={size === 28 ? "catalog__item-btn catalog__item-btn--active" : "catalog__item-btn"}
                        onClick={() => setSize(28)}
                >
                    28
                </button>

                <button className={size === 30 ? "catalog__item-btn catalog__item-btn--active" : "catalog__item-btn"}
                        onClick={() => setSize(30)}
                >
                    30
                </button>
